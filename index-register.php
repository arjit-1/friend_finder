...
if(isset($_POST['login_button']))
{
  ...
  $c=mysqli_num_rows($result);
    if($c==1)
    {
      header('Location: /sn/friend-finder/newsfeed.html');
        }
            ...
            <div class="reg-form-container"> 
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="register">
                  ...
                  <!--Register Form-->
                  <form name="registration_form" id='registration_form' class="form-inline" method="post" action="register.php">
                    <div class="row">
                  ...
                  <input type="submit" name="register_now" class="btn btn-primary">Register Now  
                ...
                <div class="tab-pane" id="login">
                  ...
                  <!--Login Form-->
                  <form name="Login_form" id='Login_form' action="index-register.php" method="post">
                     <div class="row">
                      <div class="form-group col-xs-12">
